...
def create_optimizer_new(loss, init_lr, num_train_steps, num_warmup_steps, variable_list=None, hvd=None, manual_fp16=False, use_fp16=False, optimizer_algo="adam"):
  """Creates an optimizer training op."""
  global_step = tf.train.get_or_create_global_step()
