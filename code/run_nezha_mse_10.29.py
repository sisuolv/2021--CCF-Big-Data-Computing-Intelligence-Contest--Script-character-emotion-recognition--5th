...
def get_data_ids(data_ids, is_training=True, train_flag=False):
    ...
    for i, data_tmp in enumerate(data_resd_all):
        ...
        while len(history_str_before) < 160 or count < 5:
        ...
        if len(content_token) > 192:
            truncate_seq_pair_new(history_token_before, history_token_after, FLAGS.max_seq_length - 192 - 4)
        else:
            ...
            with tf.Session() as sess:
                ...
                for epoch in range(FLAGS.num_train_epochs):
                    ...
                    for batch in next_batch(FLAGS.train_batch_size, train_in_ids, train_in_masks, train_seg_ids, train_lab_ids):
                        ...
                        current_step += 1
                        if current_step % FLAGS.save_checkpoints_steps == 0 and current_step > 300:
